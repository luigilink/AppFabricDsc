#
# Module manifest for module 'xAppFabric'
#
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/luigilink/xAppFabric/blob/master/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/luigilink/xAppFabric'
